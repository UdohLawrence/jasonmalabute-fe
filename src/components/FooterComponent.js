      ...
      <div className="w-full text-center px-6 py-6">
        <div className="w-full max-w-6xl flex flex-col gap-4 sm:flex-row mx-auto justify-between sm:items-center sm:justify-between text-white">
          ...
          <FooterLinkGroup className="flex flex-col md:flex-row gap-3">
            <FooterLink href="/about" className="text-xl font-semibold text-gray-600">
              About
            </FooterLink>
            <FooterLink href="/deals" className="text-xl font-semibold text-gray-600">
              Sample Deal
            </FooterLink>
            <FooterLink href="/contact" className="text-xl font-semibold text-gray-600">
              Contact Us
            </FooterLink>
          </FooterLinkGroup>
        </div>
